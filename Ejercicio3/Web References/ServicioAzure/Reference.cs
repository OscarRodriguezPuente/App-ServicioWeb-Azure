...
namespace Ejercicio3.ServicioAzure {
    using System;
    ...
    public partial class ServicioWeb : System.Web.Services.Protocols.SoapHttpClientProtocol {
        ...
        /// <remarks/>
        public ServicioWeb() {
            this.Url = "https://servicioparawebmovil.azurewebsites.net/ServicioWeb.asmx";
        ...
        public bool Guardar(string Nombre, string Domicilio, int Edad) {
        ...
        /// <remarks/>
        public void GuardarAsync(string Nombre, string Domicilio, int Edad) {
            this.GuardarAsync(Nombre, Domicilio, Edad, null);
        }
        
        /// <remarks/>
        public void GuardarAsync(string Nombre, string Domicilio, int Edad, object userState) {
            ...
            this.InvokeAsync("Guardar", new object[] {
                        Nombre,
                        Domicilio,
                        Edad}, this.GuardarOperationCompleted, userState);
        }
